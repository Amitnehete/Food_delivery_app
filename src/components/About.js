...
//         <div>
//             {/* <h1>About</h1> */}
//             {/* <h2>my name is Amit Neheteand this is me about us page.</h2> */}
//           <User name={'Amit Nehete '} location={''}/>
//         </div>
//     )
// }
// ****************END*********************
...
const About = () => {
  ...
  const email = "amitnehete1998@gmail.com";
    ...
    <div className="main w-full flex flex-col justify-center items-center ">
      <div className="mainBodyRestaurantMenu w-full flex flex-col items-center lg:w-[60%] max-[800px]:px-3 ">
        <div className="firstresNameDetails flex justify-between w-full px-2 my-4 lg:mx-10 ">
          <div className="left flex flex-col justify-center gap-2  rounded-xl">
            <h1 className="name text-lg font-bold font-open  max-[900px]:w-full md:text-2xl">
              AMIT NEHETE
            </h1>
      ...
      <div className="ACCORDIANS w-[90%] mb-5 flex flex-col justify-center items-center gap-1 lg:mb-10">
        ...
        >
          ...
          <span className="pr-4">
            {activeItem === "me" ? <RxCross2 /> : <RiAddLargeLine />}
          </span>
        </div>
        {activeItem === "aboutme" && (
          <div className="flex mb-3 justify-center items-center font-sans bg-black/5 rounded-xl lg:w-[70%]">
            <div className="content px-4 text-sm font-medium py-4 p-2">
              A results-driven Frontend Developer with a passion for creating
              exceptional user experiences through innovative design and
              efficient coding practices. Committed to delivering
              high-performance web applications that drive business success and
              user satisfaction.
            </div>
          </div>
        )}
        ...
        >
          ...
          <span className="pr-4">
            {activeItem === "skills" ? <RxCross2 /> : <RiAddLargeLine />}
          </span>
        </div>
        {activeItem === "skills" && (
        ...
        >
          ...
          <span className="pr-4">
            {activeItem === "socials" ? <RxCross2 /> : <RiAddLargeLine />}
          </span>
        </div>
        {activeItem === "socials" && (
          <div className="flex w-full mb-3 justify-center items-center font-sans bg-black/5 rounded-xl py-3 lg:w-[70%]">
            <div className="content px-4 text-sm  p-2 flex justify-around w-full">
              <Link to="https://www.linkedin.com/in/amit-nehete-460672208/">
                <img
                  className="w-10"
              ...
              <Link to="https://github.com/Amitnehete/">
                <img
                  className="w-10"
          ...
          <div className="flex mb-3 justify-center items-center font-sans bg-black/5  hover:bg-gray-300 lg:w-[70%]">
            <div className="content px-4 text-sm  p-2 flex flex-col justify-start gap-2">
              <ul className="flex flex-col justify-between gap-2 lg:items-start">
                ...
                <li>- Real time Swiggy API DATA.</li>
                ...
                <li>- Your Current Location Will be at Top🔝</li>
              </ul>
              ...
              <div className="flex flex-col justify-between lg:items-start gap-2">
                ...
                <Link to="#">
                  <button className=" bg-green-400 hover:bg-green-500 rounded-lg p-2 lg:text-xl font-semibold px-4">
                    Live link
                  </button>
                </Link>
                <Link to="https://github.com/Amitnehete/Food_delivery_app">
                  <button className="bg-green-400 hover:bg-green-500 rounded-lg p-2 lg:text-xl font-semibold px-4">
                    Github link
                  </button>
                </Link>
        ...
        >
          ...
          <span className="pr-4">
            {activeItem === "resume" ? <RxCross2 /> : <RiAddLargeLine />}
          </span>
        </div>
        {activeItem === "resume" && (
          <div className="flex w-full mb-3 justify-center items-center font-sans bg-black/5 hover:bg-gray-300 px-2 rounded-xl  lg:w-[70%]">
            <div className="content px-4 text-sm p-2 w-full rounded-xl">
              <a
                ...
                href="https://drive.google.com/file/d/13yQ273CngdCp8IiQcOiW8Er6f5ArU7aw/view?usp=drive_link"
                download="resume.pdf"
              >
