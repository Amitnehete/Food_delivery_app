    ...
    >
      <div className="res-card w-[16.2rem] min-h-[18rem] flex flex-col justify-start items-start gap-3 ">
        ...
        <div className="flex flex-row gap-4 justify-between items-center w-full">
          <div
            className={`rating ${rateColor} px-[0.3rem] py-[0rem] flex flex-row items-center gap-1 font-open text-xs font-semibold text-white`}
          >
            <AiFillStar className="staricon " />
            <span className="number text-[0.8rem]">{avgRating}</span>
          </div>
