  ...
  return (
    <div className="w-full shadow-lg bg-white fixed bottom-0 md:hidden">
      <ul className="items flex w-full justify-around items-center m-2 ">
        <div className="loginout  flex  gap-[5px] justify-center items-center cursor-pointer p-2  w-24">
          <PermIdentityIcon />

          {loginToken ? (
            <button
              className="btnname  cursor-pointer "
        ...
        <Link to="/about">
          <div className="slogo w-10 rounded-lg">
            <img
              ...
              src="https://i.postimg.cc/gjCkWqQr/V-logo.jpg"
              alt=""
            />
          </div>
        </Link>
